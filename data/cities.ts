...
export const CITIES: City[] = [
  {
    ...
    restaurants: [
      { id: 'cara-r1', name: 'Restaurante Martins', category: 'frutos_do_mar', priceRange: 3, averageTicket: 80, rating: 4.5, address: 'Av. da Praia, 520 - Porto Novo, Caraguatatuba', lat: -23.6310, lng: -45.4088, highlights: ['Moqueca caiçara', 'Vista pro mar', 'Frutos do mar do dia'], mapsUrl: 'https://maps.google.com/?q=Restaurante+Martins+Caraguatatuba' },
      { id: 'cara-r2', name: 'Cantina do Pescador', category: 'frutos_do_mar', priceRange: 2, averageTicket: 55, rating: 4.3, address: 'R. Frei Gaspar, 346 - Centro, Caraguatatuba', lat: -23.6195, lng: -45.4130, highlights: ['Peixe frito na chapa', 'Pirão caiçara', 'Almoço executivo'], mapsUrl: 'https://maps.google.com/?q=Cantina+do+Pescador+Caraguatatuba' },
      { id: 'cara-r3', name: 'Churrascaria Caipira', category: 'churrasco', priceRange: 2, averageTicket: 58, rating: 4.0, address: 'Av. Presidente Kennedy, 1100 - Martim de Sá, Caraguatatuba', lat: -23.5940, lng: -45.3700, highlights: ['Rodízio completo', 'Buffet de saladas', 'Caipirinha de fruta'], mapsUrl: 'https://maps.google.com/?q=Churrascaria+Caipira+Caraguatatuba' },
      { id: 'cara-r4', name: 'Café Orla de Martim', category: 'cafe', priceRange: 1, averageTicket: 25, rating: 4.3, address: 'Av. da Praia, 180 - Martim de Sá, Caraguatatuba', lat: -23.5938, lng: -45.3695, highlights: ['Açaí artesanal', 'Vista pro mar', 'Brunch fins de semana'], mapsUrl: 'https://maps.google.com/?q=Cafe+Orla+Martim+Caraguatatuba' },
      { id: 'cara-r5', name: 'Bar do Coqueiro', category: 'bar', priceRange: 1, averageTicket: 30, rating: 4.1, address: 'Av. da Praia, s/n - Porto Novo, Caraguatatuba', lat: -23.6318, lng: -45.4095, highlights: ['Petisco de siri', 'Cerveja gelada', 'Quiosque na areia'], mapsUrl: 'https://maps.google.com/?q=Bar+do+Coqueiro+Porto+Novo+Caraguatatuba' },
      { id: 'cara-r6', name: 'Restaurante Pousada do Sol', category: 'variado', priceRange: 2, averageTicket: 45, rating: 4.2, address: 'Av. Adhemar de Barros, 654 - Centro, Caraguatatuba', lat: -23.6200, lng: -45.4120, highlights: ['Prato feito caiçara', 'Comida caseira', 'Self-service no almoço'], mapsUrl: 'https://maps.google.com/?q=Restaurante+Pousada+do+Sol+Caraguatatuba' },
    ],
    attractions: [
...

  {
    ...
    restaurants: [
      { id: 'uba-r1', name: 'Restaurante Siri Mole', category: 'frutos_do_mar', priceRange: 3, averageTicket: 90, rating: 4.7, address: 'Av. Leovegildo Dias Vieira, 540 - Centro, Ubatuba', lat: -23.4338, lng: -45.0840, highlights: ['Siri mole exclusivo', 'Lagosta ao alho e óleo', 'Vista para o mar'], mapsUrl: 'https://maps.google.com/?q=Siri+Mole+Ubatuba' },
      { id: 'uba-r2', name: 'Caiçara Grill', category: 'variado', priceRange: 2, averageTicket: 48, rating: 4.4, address: 'R. Conceição, 320 - Centro, Ubatuba', lat: -23.4330, lng: -45.0835, highlights: ['Frutos do mar e carnes', 'Ambiente caiçara autêntico', 'Porções generosas'], mapsUrl: 'https://maps.google.com/?q=Caicara+Grill+Ubatuba' },
      { id: 'uba-r3', name: 'Bar e Restaurante Enseada', category: 'bar', priceRange: 1, averageTicket: 28, rating: 4.1, address: 'Av. Leovegildo Dias Vieira, 1020 - Enseada, Ubatuba', lat: -23.4958, lng: -45.1100, highlights: ['Pastel de siri', 'Chope gelado', 'Quiosque na praia'], mapsUrl: 'https://maps.google.com/?q=Bar+Enseada+Ubatuba' },
      { id: 'uba-r4', name: 'Churrascaria do Porto', category: 'churrasco', priceRange: 2, averageTicket: 58, rating: 4.2, address: 'Av. Iperoig, 1200 - Centro, Ubatuba', lat: -23.4342, lng: -45.0845, highlights: ['Costela na brasa', 'Buffet de saladas', 'Rodízio completo'], mapsUrl: 'https://maps.google.com/?q=Churrascaria+Porto+Ubatuba' },
      { id: 'uba-r5', name: 'Café da Praça', category: 'cafe', priceRange: 1, averageTicket: 22, rating: 4.4, address: 'Praça Nóbrega, s/n - Centro, Ubatuba', lat: -23.4335, lng: -45.0838, highlights: ['Café coado na hora', 'Tapioca e cuscuz', 'Vista para a praça histórica'], mapsUrl: 'https://maps.google.com/?q=Cafe+da+Praca+Ubatuba' },
      { id: 'uba-r6', name: 'Restaurante Picinguaba', category: 'frutos_do_mar', priceRange: 2, averageTicket: 55, rating: 4.6, address: 'Vila de Picinguaba, s/n - Picinguaba, Ubatuba', lat: -23.3705, lng: -44.9405, highlights: ['Peixe caiçara assado na folha', 'Moqueca de camarão', 'Vila histórica tombada'], mapsUrl: 'https://maps.google.com/?q=Restaurante+Picinguaba+Ubatuba' },
    ],
    attractions: [
