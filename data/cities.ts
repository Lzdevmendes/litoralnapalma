...
export const CITIES: City[] = [
...

  {
    ...
    restaurants: [
      ...
      { id: 'ss-r2', name: 'Terral Restaurante', category: 'frutos_do_mar', priceRange: 3, averageTicket: 95, rating: 4.8, address: 'R. Manacá, 102 - Camburi, São Sebastião', lat: -23.7780, lng: -45.6532, highlights: ['Moqueca e filé de peixe', 'Risoto com camarão e açafrão', 'Em meio à Mata Atlântica'], mapsUrl: 'https://maps.google.com/?q=-23.7672,-45.5879&z=17' },
      { id: 'ss-r3', name: 'Ogan Restaurante', category: 'frutos_do_mar', priceRange: 2, averageTicket: 70, rating: 4.5, address: 'Av. Mãe Bernarda, 637 - Juqueí, São Sebastião', lat: -23.7692, lng: -45.7280, highlights: ['Camarão flambado com risoto de pera', 'Peixe do dia', 'Vista pro mangue do Juqueí'], mapsUrl: 'https://maps.google.com/?q=-23.7712,-45.4891&z=17' },
...

  {
    ...
    restaurants: [
      { id: 'uba-r1', name: 'Rei do Camarão', category: 'frutos_do_mar', priceRange: 2, averageTicket: 75, rating: 4.7, address: 'Av. Leovegildo Dias Vieira, 38 - Itaguá, Ubatuba', lat: -23.4474, lng: -45.0680, highlights: ['Camarão à grega premiado', 'TripAdvisor Travelers\' Choice 2025', 'Especialidade da casa: camarão na moranga'], mapsUrl: 'https://maps.google.com/?q=-23.4338,-45.0840&z=17' },
...

  {
    ...
    restaurants: [
      { id: 'ilh-r1', name: 'Restaurante Viana', category: 'frutos_do_mar', priceRange: 3, averageTicket: 110, rating: 4.8, address: 'Av. Leonardo Reale, 2301 - Praia Viana, Ilhabela', lat: -23.7588, lng: -45.3508, highlights: ['Casquinha do Viana — receita patenteada', '60 anos de tradição — família Schoof', 'Mesa na areia da Praia Viana'], mapsUrl: 'https://maps.google.com/?q=-23.7613,-45.3438&z=17' },
