...
export const CITIES: City[] = [
  {
    ...
    beaches: [
      ...
      { id: 'martim-de-sa',  name: 'Martim de Sá',        waterQuality: 'boa',     lat: -23.6270, lng: -45.3822, amenities: { banheiros: true,  quiosques: true,  estacionamento: true  } },
    ...
    restaurants: [
      { id: 'cara-r1', name: 'Guaruçá Frutos do Mar', category: 'frutos_do_mar', priceRange: 3, averageTicket: 85, rating: 4.6, address: 'Av. Dr. Arthur da Costa Filho, 27 - Centro, Caraguatatuba', lat: -23.6192, lng: -45.4140, highlights: ['Casquinha de camarão premiada', 'Mais de 20 anos de tradição', 'Moqueca caiçara premiada'], mapsUrl: 'https://maps.google.com/?q=Guaruçá+Frutos+do+Mar,+Caraguatatuba,+SP&ll=-23.6192,-45.4140' },
...

  {
    ...
    beaches: [
      ...
      { id: 'lazaro',              name: 'Praia do Lázaro',               waterQuality: 'boa',      lat: -23.5028, lng: -45.1363, amenities: { banheiros: false, quiosques: false, estacionamento: false } },
