...
export const CITIES: City[] = [
  {
    ...
    sideRoutes: [
      ...
      { id: 'cara-sr4', name: 'Praia de Massaguaçu', description: 'Praia extensa ao norte, geralmente mais vazia que o centro mesmo nos fins de semana.', type: 'praia', distance: 7, estimatedTime: 12, tags: ['praia', 'surf', 'norte'], lat: -23.5621, lng: -45.3291, mapsUrl: 'https://maps.google.com/?q=-23.5621,-45.3291&z=17' },
    ],
  },

  {
    ...
    sideRoutes: [
      { id: 'ss-sr1', name: 'Praia de Camburi', description: 'Uma das mais preservadas do litoral paulista — proibida música alta, ideal para quem foge da multidão.', type: 'praia', distance: 28, estimatedTime: 40, tags: ['praia', 'natureza', 'preservada'], lat: -23.7672, lng: -45.5879, mapsUrl: 'https://maps.google.com/?q=-23.7672,-45.5879&z=17' },
      ...
      { id: 'ss-sr4', name: 'Centro Histórico de São Sebastião', description: 'Casarões coloniais do século XVII ao redor do porto mais antigo do litoral paulista.', type: 'cultural', distance: 2, estimatedTime: 5, tags: ['história', 'colonial', 'museu'], lat: -23.8090, lng: -45.4080, mapsUrl: 'https://maps.google.com/?q=-23.8090,-45.4080&z=17' },
    ],
  },

  {
    ...
    restaurants: [
      { id: 'uba-r1', name: 'Rei do Camarão', category: 'frutos_do_mar', priceRange: 2, averageTicket: 75, rating: 4.7, address: 'Av. Leovegildo Dias Vieira, 38 - Itaguá, Ubatuba', lat: -23.4338, lng: -45.0840, highlights: ['Camarão à grega premiado', 'TripAdvisor Travelers\' Choice 2025', 'Especialidade da casa: camarão na moranga'], mapsUrl: 'https://maps.google.com/?q=-23.4338,-45.0840&z=17' },
    ...
    sideRoutes: [
      { id: 'uba-sr1', name: 'Praia do Félix', description: 'Praia escondida de acesso difícil, raramente lotada — ideal quando as centrais estiverem cheias.', type: 'praia', distance: 14, estimatedTime: 22, tags: ['praia', 'escondida', 'tranquilo'], lat: -23.4850, lng: -45.0850, mapsUrl: 'https://maps.google.com/?q=-23.4850,-45.0850&z=17' },
      ...
      { id: 'uba-sr4', name: 'Ilha Anchieta', description: 'Ilha com ruínas históricas, praias cristalinas e snorkel incrível — barco sai do Saco da Ribeira.', type: 'praia', distance: 20, estimatedTime: 40, tags: ['ilha', 'snorkel', 'histórico'], lat: -23.5350, lng: -45.0760, mapsUrl: 'https://maps.google.com/?q=-23.5350,-45.0760&z=17' },
    ],
  },

  {
    ...
    attractions: [
      ...
      { id: 'ilh-a2', name: 'Pico do Baepi', type: 'trilha', description: 'Trilha até os 640m de altitude, com vista de 360° do arquipélago de Ilhabela e do continente.', entryFee: null, rating: 4.8, lat: -23.7800, lng: -45.3200, tips: ['Saída às 6h para evitar chuva da tarde', 'Guia obrigatório em temporada', 'Nível difícil — prepare-se fisicamente'], mapsUrl: 'https://maps.google.com/?q=-23.7800,-45.3200&z=17' },
    ...
    sideRoutes: [
      ...
      { id: 'ilh-sr3', name: 'Pico do Baepi', description: 'Trilha até 640m com vista de 360° do arquipélago — saída às 6h para evitar chuva da tarde.', type: 'trilha', distance: 8, estimatedTime: 30, difficulty: 'difícil', tags: ['trilha', 'altitude', 'vista 360°'], lat: -23.7800, lng: -45.3200, mapsUrl: 'https://maps.google.com/?q=-23.7800,-45.3200&z=17' },
