...
export const CITIES: City[] = [
  {
    ...
    restaurants: [
      { id: 'cara-r1', name: 'Guaruçá Frutos do Mar', category: 'frutos_do_mar', priceRange: 3, averageTicket: 85, rating: 4.6, address: 'Av. Arthur Costa Filho, 1780 - Centro, Caraguatatuba', lat: -23.6192, lng: -45.4140, highlights: ['Casquinha de camarão premiada', '22 anos de tradição', 'Moqueca caiçara premiada'], mapsUrl: 'https://maps.google.com/?q=Guaruçá+Frutos+do+Mar+Caraguatatuba' },
      { id: 'cara-r2', name: 'Mar & Terra Restaurante', category: 'frutos_do_mar', priceRange: 2, averageTicket: 65, rating: 4.5, address: 'R. Maria de Lurdes Silva Kfouri, 897 - Massaguaçu, Caraguatatuba', lat: -23.5620, lng: -45.3290, highlights: ['Peixe do dia grelhado', 'Vista pro mar em Massaguaçu', 'Porções generosas'], mapsUrl: 'https://maps.google.com/?q=Mar+Terra+Restaurante+Massaguaçu+Caraguatatuba' },
      { id: 'cara-r3', name: 'Don Quixote Frutos do Mar', category: 'frutos_do_mar', priceRange: 2, averageTicket: 60, rating: 4.3, address: 'Av. Maria Carlota, 720 - Massaguaçu, Caraguatatuba', lat: -23.5615, lng: -45.3295, highlights: ['Frutos do mar frescos', 'Ambiente descontraído', 'Ótimo custo-benefício'], mapsUrl: 'https://maps.google.com/?q=Don+Quixote+Frutos+do+Mar+Caraguatatuba' },
      { id: 'cara-r4', name: 'Ostra e Ouriço', category: 'frutos_do_mar', priceRange: 2, averageTicket: 55, rating: 4.4, address: 'Av. Arthur Costa Filho, 560 - Centro, Caraguatatuba', lat: -23.6188, lng: -45.4135, highlights: ['Ostras e ouriços frescos', 'Jeito quiosque à beira-mar', 'TripAdvisor top rated'], mapsUrl: 'https://maps.google.com/?q=Ostra+e+Ouriço+Caraguatatuba' },
      { id: 'cara-r5', name: 'Bar do Pescador Porto Novo', category: 'bar', priceRange: 1, averageTicket: 30, rating: 4.1, address: 'R. dos Pescadores, 45 - Porto Novo, Caraguatatuba', lat: -23.6318, lng: -45.4095, highlights: ['Petisco de peixe frito', 'Cerveja gelada', 'Ambiente de pescadores'], mapsUrl: 'https://maps.google.com/?q=Bar+do+Pescador+Porto+Novo+Caraguatatuba' },
      { id: 'cara-r6', name: 'Restaurante e Pizzaria Cará', category: 'pizza', priceRange: 2, averageTicket: 48, rating: 4.2, address: 'Av. Adhemar de Barros, 654 - Centro, Caraguatatuba', lat: -23.6200, lng: -45.4120, highlights: ['Pizza de camarão', 'Rodízio nas sextas', 'Opção para famílias'], mapsUrl: 'https://maps.google.com/?q=Pizzaria+Cara+Centro+Caraguatatuba' },
    ],
    attractions: [
      { id: 'cara-a1', name: 'Cachoeira do Paraibuna', type: 'cachoeira', description: 'Cachoeira de água cristalina no sopé da Serra do Mar, com piscinas naturais e mata preservada.', entryFee: null, rating: 4.6, lat: -23.5200, lng: -45.4500, tips: ['Leve repelente', 'Melhor de manhã cedo', 'Água fria — leve agasalho'], mapsUrl: 'https://maps.google.com/?q=Cachoeira+do+Paraibuna+Caraguatatuba' },
      { id: 'cara-a2', name: 'Mirante do Morro São João', type: 'mirante', description: 'Vista panorâmica de 360° do litoral norte, do centro de Caraguatatuba às ilhas ao horizonte.', entryFee: null, rating: 4.4, lat: -23.6050, lng: -45.4300, tips: ['Melhor ao entardecer', 'Trilha de 40 min', 'Leve lanterna se for à noite'], mapsUrl: 'https://maps.google.com/?q=Mirante+Morro+São+João+Caraguatatuba' },
      { id: 'cara-a3', name: 'Parque Estadual da Serra do Mar', type: 'parque', description: 'Maior remanescente de Mata Atlântica do estado, com trilhas, cachoeiras e fauna exuberante.', entryFee: 10, rating: 4.7, lat: -23.5500, lng: -45.5000, tips: ['Reserva obrigatória no site', 'Proibido entrar com comida', 'Guia é obrigatório para trilhas longas'], mapsUrl: 'https://maps.google.com/?q=Parque+Estadual+Serra+do+Mar+Caraguatatuba' },
      { id: 'cara-a4', name: 'Igreja Matriz N. Sra. da Ajuda', type: 'historico', description: 'Igreja do século XVIII, um dos símbolos históricos de Caraguatatuba, reconstruída após o deslizamento de 1967.', entryFee: null, rating: 4.0, lat: -23.6201, lng: -45.4129, tips: ['Visitas guiadas às quintas', 'Museu no interior', 'Evento junino imperdível'], mapsUrl: 'https://maps.google.com/?q=Igreja+Matriz+Nossa+Senhora+Ajuda+Caraguatatuba' },
    ],
    sideRoutes: [
      { id: 'cara-sr1', name: 'Cachoeira do Paraibuna', description: 'Cachoeira de água cristalina no sopé da Serra do Mar — alternativa fresca ao calor da praia.', type: 'cachoeira', distance: 22, estimatedTime: 35, difficulty: 'moderado', tags: ['cachoeira', 'natureza', 'frescor'], lat: -23.5200, lng: -45.4500, mapsUrl: 'https://maps.google.com/?q=Cachoeira+do+Paraibuna,+Caraguatatuba,+SP&ll=-23.5200,-45.4500' },
      { id: 'cara-sr2', name: 'Mirante do Morro São João', description: 'Vista panorâmica de 360° do litoral norte — ideal quando a Rio-Santos está travada.', type: 'trilha', distance: 8, estimatedTime: 15, difficulty: 'fácil', tags: ['mirante', 'trilha', 'pôr do sol'], lat: -23.6050, lng: -45.4300, mapsUrl: 'https://maps.google.com/?q=Mirante+Morro+São+João,+Caraguatatuba,+SP&ll=-23.6050,-45.4300' },
      { id: 'cara-sr3', name: 'Praia de Tabatinga', description: 'Praia calma no sul da cidade, bem menos frequentada que o Centro.', type: 'praia', distance: 8, estimatedTime: 12, tags: ['praia', 'tranquilo', 'sul'], lat: -23.6415, lng: -45.4200, mapsUrl: 'https://maps.google.com/?q=Praia+de+Tabatinga,+Caraguatatuba,+SP&ll=-23.6415,-45.4200' },
      { id: 'cara-sr4', name: 'Praia de Massaguaçu', description: 'Praia extensa ao norte, geralmente mais vazia que o centro mesmo nos fins de semana.', type: 'praia', distance: 7, estimatedTime: 12, tags: ['praia', 'surf', 'norte'], lat: -23.5621, lng: -45.3291, mapsUrl: 'https://maps.google.com/?q=Praia+de+Massaguaçu,+Caraguatatuba,+SP&ll=-23.5621,-45.3291' },
    ],
  },

  {
    ...
    restaurants: [
      { id: 'ss-r1', name: 'Ravenala Restaurante', category: 'frutos_do_mar', priceRange: 3, averageTicket: 90, rating: 4.7, address: 'R. Sebastião Romão César, 400 - Maresias, São Sebastião', lat: -23.8004, lng: -45.5313, highlights: ['Ingredientes frescos e locais', 'Moqueca premiada', 'Vista para Maresias'], mapsUrl: 'https://maps.google.com/?q=Ravenala+Restaurante+Maresias+São+Sebastião' },
      { id: 'ss-r2', name: 'Terral Restaurante', category: 'frutos_do_mar', priceRange: 3, averageTicket: 95, rating: 4.8, address: 'R. Manacá, 102 - Camburi, São Sebastião', lat: -23.7672, lng: -45.5879, highlights: ['Moqueca e filé de peixe', 'Risoto com camarão e açafrão', 'Em meio à Mata Atlântica'], mapsUrl: 'https://maps.google.com/?q=Terral+Restaurante+Camburi+São+Sebastião' },
      { id: 'ss-r3', name: 'Ogan Restaurante', category: 'frutos_do_mar', priceRange: 2, averageTicket: 70, rating: 4.5, address: 'Av. Mãe Bernarda, 637 - Juqueí, São Sebastião', lat: -23.7712, lng: -45.4891, highlights: ['Camarão flambado com risoto de pera', 'Peixe do dia', 'Vista pro mangue do Juqueí'], mapsUrl: 'https://maps.google.com/?q=Ogan+Restaurante+Juquei+São+Sebastião' },
      { id: 'ss-r4', name: 'Caravela Restaurante', category: 'frutos_do_mar', priceRange: 2, averageTicket: 65, rating: 4.4, address: 'Av. Walkir Vergani, 253 - Boiçucanga, São Sebastião', lat: -23.8133, lng: -45.5706, highlights: ['Ceviche de peixe no coco', 'Carpaccio de salmão', 'Terraço com vista pro mar'], mapsUrl: 'https://maps.google.com/?q=Caravela+Restaurante+Boicucanga+São+Sebastião' },
      { id: 'ss-r5', name: 'Acqua Restaurante Camburi', category: 'variado', priceRange: 3, averageTicket: 85, rating: 4.6, address: 'Al. Antonio José Marques, 2000 - Camburi, São Sebastião', lat: -23.7680, lng: -45.5870, highlights: ['Vista 180° para o mar', 'Risotos e frutos do mar', 'Cozinha italiana e brasileira'], mapsUrl: 'https://maps.google.com/?q=Acqua+Restaurante+Camburi+São+Sebastião' },
      { id: 'ss-r6', name: 'Café Topolândia', category: 'cafe', priceRange: 1, averageTicket: 22, rating: 4.0, address: 'R. João Lino da Silva, 120 - Topolândia, São Sebastião', lat: -23.7958, lng: -45.4083, highlights: ['Café especial da Serra', 'Tapioca recheada', 'Próximo à UPA'], mapsUrl: 'https://maps.google.com/?q=Café+Topolândia+São+Sebastião' },
    ],
    attractions: [
      { id: 'ss-a1', name: 'Praia de Camburi', type: 'praia', description: 'Uma das praias mais preservadas do litoral paulista, rodeada de Mata Atlântica e com águas calmas.', entryFee: null, rating: 4.8, lat: -23.7672, lng: -45.5879, tips: ['Proibido barracas de som', 'Estacionamento pago na entrada', 'Chegar cedo para pegar vaga'], mapsUrl: 'https://maps.google.com/?q=Praia+de+Camburi+São+Sebastião' },
      { id: 'ss-a2', name: 'Museu de Arte Sacra de São Sebastião', type: 'historico', description: 'Acervo com peças do século XVII ao XIX, na casa histórica do Porto — uma das mais antigas do litoral.', entryFee: 5, rating: 4.2, lat: -23.8092, lng: -45.4082, tips: ['Fechado às segundas', 'Visita guiada inclusa no ingresso', 'Loja de artesanato na saída'], mapsUrl: 'https://maps.google.com/?q=Museu+Arte+Sacra+São+Sebastião+SP' },
      { id: 'ss-a3', name: 'Trilha do Costão', type: 'trilha', description: 'Trilha de nível moderado entre costões rochosos com vista espetacular para as ilhas de São Sebastião.', entryFee: null, rating: 4.5, lat: -23.8100, lng: -45.4100, tips: ['Leve água e protetor solar', 'Boa forma física recomendada', 'Saída às 7h para evitar sol forte'], mapsUrl: 'https://maps.google.com/?q=Trilha+do+Costão+São+Sebastião+SP' },
      { id: 'ss-a4', name: 'Lagoa dos Bambus', type: 'parque', description: 'Lagoa de água doce cercada de bambuzal exótico, ótima para stand-up paddle e contemplação.', entryFee: null, rating: 4.3, lat: -23.7900, lng: -45.5050, tips: ['Aluguel de SUP no local', 'Mosquitos ao entardecer — leve repelente', 'Ótima para fotos'], mapsUrl: 'https://maps.google.com/?q=Lagoa+dos+Bambus,+São+Sebastião,+SP&ll=-23.7900,-45.5050' },
    ],
    sideRoutes: [
      { id: 'ss-sr1', name: 'Praia de Camburi', description: 'Uma das mais preservadas do litoral paulista — proibida música alta, ideal para quem foge da multidão.', type: 'praia', distance: 28, estimatedTime: 40, tags: ['praia', 'natureza', 'preservada'], lat: -23.7672, lng: -45.5879, mapsUrl: 'https://maps.google.com/?q=Praia+de+Camburi,+São+Sebastião,+SP&ll=-23.7672,-45.5879' },
      { id: 'ss-sr2', name: 'Trilha do Costão', description: 'Trilha moderada entre costões rochosos com vistas espetaculares para as ilhas de São Sebastião.', type: 'trilha', distance: 5, estimatedTime: 20, difficulty: 'moderado', tags: ['trilha', 'costão', 'vista'], lat: -23.8100, lng: -45.4100, mapsUrl: 'https://maps.google.com/?q=Trilha+do+Costão,+São+Sebastião,+SP&ll=-23.8100,-45.4100' },
      { id: 'ss-sr3', name: 'Lagoa dos Bambus', description: 'Lagoa de água doce cercada de bambuzal — aluguel de SUP no local, longe do barulho da praia.', type: 'cachoeira', distance: 25, estimatedTime: 35, tags: ['lagoa', 'paddle', 'tranquilo'], lat: -23.7900, lng: -45.5050, mapsUrl: 'https://maps.google.com/?q=Lagoa+dos+Bambus,+São+Sebastião,+SP&ll=-23.7900,-45.5050' },
      { id: 'ss-sr4', name: 'Centro Histórico de São Sebastião', description: 'Casarões coloniais do século XVII ao redor do porto mais antigo do litoral paulista.', type: 'cultural', distance: 2, estimatedTime: 5, tags: ['história', 'colonial', 'museu'], lat: -23.8090, lng: -45.4080, mapsUrl: 'https://maps.google.com/?q=Centro+Histórico+São+Sebastião,+São+Sebastião,+SP&ll=-23.8090,-45.4080' },
    ],
  },

  {
    ...
    restaurants: [
      { id: 'uba-r1', name: 'Rei do Camarão', category: 'frutos_do_mar', priceRange: 2, averageTicket: 75, rating: 4.7, address: 'Av. Leovegildo Dias Vieira, 38 - Itaguá, Ubatuba', lat: -23.4338, lng: -45.0840, highlights: ['Camarão à grega premiado', 'TripAdvisor Travelers\' Choice 2025', 'Especialidade da casa: camarão na moranga'], mapsUrl: 'https://maps.google.com/?q=Rei+do+Camarão+Ubatuba' },
      { id: 'uba-r2', name: 'Restaurante Raízes', category: 'variado', priceRange: 2, averageTicket: 55, rating: 4.6, address: 'Av. Abner Leal, 120 - Centro, Ubatuba', lat: -23.4330, lng: -45.0835, highlights: ['Um dos melhores do Litoral Norte', 'Culinária regional autêntica', 'Ingredientes locais'], mapsUrl: 'https://maps.google.com/?q=Restaurante+Raízes+Ubatuba' },
      { id: 'uba-r3', name: 'Tachão Restaurante', category: 'variado', priceRange: 1, averageTicket: 38, rating: 4.3, address: 'Av. Leovegildo Dias Vieira, 380 - Centro, Ubatuba', lat: -23.4342, lng: -45.0843, highlights: ['Doce de banana com canela', 'Cachaça artesanal', 'Culinária caiçara tradicional'], mapsUrl: 'https://maps.google.com/?q=Tachão+Restaurante+Ubatuba' },
      { id: 'uba-r4', name: 'Pizzaria São Paulo', category: 'pizza', priceRange: 2, averageTicket: 50, rating: 4.5, address: 'R. Conceição, 260 - Centro, Ubatuba', lat: -23.4338, lng: -45.0837, highlights: ['Premiada pela Revista Veja', 'Tradição em Ubatuba', 'Pizza de frutos do mar imperdível'], mapsUrl: 'https://maps.google.com/?q=Pizzaria+São+Paulo+Ubatuba' },
      { id: 'uba-r5', name: 'Café da Praça Nóbrega', category: 'cafe', priceRange: 1, averageTicket: 22, rating: 4.3, address: 'Praça Nóbrega, s/n - Centro, Ubatuba', lat: -23.4335, lng: -45.0838, highlights: ['Café coado na hora', 'Tapioca artesanal', 'Praça histórica de Ubatuba'], mapsUrl: 'https://maps.google.com/?q=Café+Praça+Nóbrega+Ubatuba' },
      { id: 'uba-r6', name: 'Restaurante da Vila Picinguaba', category: 'frutos_do_mar', priceRange: 2, averageTicket: 55, rating: 4.6, address: 'Vila de Picinguaba, s/n - Picinguaba, Ubatuba', lat: -23.3705, lng: -44.9405, highlights: ['Peixe assado na folha de bananeira', 'Vila caiçara tombada pelo IPHAN', 'Experiência gastronômica única'], mapsUrl: 'https://maps.google.com/?q=Vila+Picinguaba+Restaurante+Ubatuba' },
    ],
    attractions: [
      { id: 'uba-a1', name: 'Ilha Anchieta', type: 'praia', description: 'Ilha paradisíaca com praias de águas cristalinas, ruínas do presídio histórico e trilhas na mata.', entryFee: null, rating: 4.9, lat: -23.5350, lng: -45.0760, tips: ['Barco sai do Saco da Ribeira', 'Leve lanche — sem comércio na ilha', 'Snorkel obrigatório nas piscinas naturais'], mapsUrl: 'https://maps.google.com/?q=Ilha+Anchieta+Ubatuba' },
      { id: 'uba-a2', name: 'Trilha das Sete Praias', type: 'trilha', description: 'Trilha de 10 km ligando a Praia da Lagoinha à Praia da Fortaleza, passando por 7 praias quase desertas.', entryFee: null, rating: 4.8, lat: -23.5050, lng: -45.1340, tips: ['Ponto de partida: Praia da Lagoinha (km 73 Rio-Santos)', 'Leve bastante água', 'Dia inteiro — saia cedo'], mapsUrl: 'https://maps.google.com/?q=Trilha+das+Sete+Praias+Ubatuba' },
      { id: 'uba-a3', name: 'Cachoeira da Toca', type: 'cachoeira', description: 'Cachoeira de 12 m de queda com poço natural para banho, dentro da Mata Atlântica preservada.', entryFee: null, rating: 4.6, lat: -23.4150, lng: -45.0620, tips: ['Trilha de 20 min pelo mato', 'Água gelada mesmo no verão', 'Levar calçado fechado'], mapsUrl: 'https://maps.google.com/?q=Cachoeira+da+Toca+Ubatuba' },
      { id: 'uba-a4', name: 'Parque Estadual Serra do Mar — Picinguaba', type: 'parque', description: 'Núcleo de preservação com praias selvagens, comunidade caiçara e trilhas com vista para o Atlântico.', entryFee: 12, rating: 4.8, lat: -23.3701, lng: -44.9401, tips: ['Reserva prévia obrigatória no site do PESM', 'Guia credenciado recomendado', 'Proibido acampar sem autorização'], mapsUrl: 'https://maps.google.com/?q=Núcleo+Picinguaba+Parque+Estadual+Serra+do+Mar+Ubatuba' },
    ],
    sideRoutes: [
      { id: 'uba-sr1', name: 'Praia do Félix', description: 'Praia escondida de acesso difícil, raramente lotada — ideal quando as centrais estiverem cheias.', type: 'praia', distance: 14, estimatedTime: 22, tags: ['praia', 'escondida', 'tranquilo'], lat: -23.4850, lng: -45.0850, mapsUrl: 'https://maps.google.com/?q=Praia+do+Félix,+Ubatuba,+SP&ll=-23.4850,-45.0850' },
      { id: 'uba-sr2', name: 'Cachoeira da Toca', description: 'Cachoeira de 12m com poço natural de água gelada, trilha de 20 min pela mata fechada.', type: 'cachoeira', distance: 6, estimatedTime: 20, difficulty: 'fácil', tags: ['cachoeira', 'trilha', 'frescor'], lat: -23.4150, lng: -45.0620, mapsUrl: 'https://maps.google.com/?q=Cachoeira+da+Toca,+Ubatuba,+SP&ll=-23.4150,-45.0620' },
      { id: 'uba-sr3', name: 'Núcleo Picinguaba — Serra do Mar', description: 'Trilha com comunidade caiçara, praias selvagens quase intocadas e matas de Mata Atlântica.', type: 'trilha', distance: 38, estimatedTime: 55, difficulty: 'moderado', tags: ['parque', 'trilha', 'caiçara'], lat: -23.3701, lng: -44.9401, mapsUrl: 'https://maps.google.com/?q=Núcleo+Picinguaba+Serra+do+Mar,+Ubatuba,+SP&ll=-23.3701,-44.9401' },
      { id: 'uba-sr4', name: 'Ilha Anchieta', description: 'Ilha com ruínas históricas, praias cristalinas e snorkel incrível — barco sai do Saco da Ribeira.', type: 'praia', distance: 20, estimatedTime: 40, tags: ['ilha', 'snorkel', 'histórico'], lat: -23.5350, lng: -45.0760, mapsUrl: 'https://maps.google.com/?q=Ilha+Anchieta,+Ubatuba,+SP&ll=-23.5350,-45.0760' },
    ],
  },

  {
    ...
    restaurants: [
      { id: 'ilh-r1', name: 'Restaurante Viana', category: 'frutos_do_mar', priceRange: 3, averageTicket: 110, rating: 4.8, address: 'Av. Leonardo Reale, 2301 - Praia Viana, Ilhabela', lat: -23.7613, lng: -45.3438, highlights: ['Casquinha do Viana — receita patenteada', '60 anos de tradição — família Schoof', 'Mesa na areia da Praia Viana'], mapsUrl: 'https://maps.google.com/?q=Restaurante+Viana+Ilhabela' },
      { id: 'ilh-r2', name: 'Restaurante Manjericão', category: 'frutos_do_mar', priceRange: 2, averageTicket: 70, rating: 4.5, address: 'Av. Força Expedicionária Brasileira, 20 - Barreiro, Ilhabela', lat: -23.7762, lng: -45.3516, highlights: ['Peixe e frutos do mar fresquíssimos', 'Ambiente caiçara típico', 'Na vilinha central'], mapsUrl: 'https://maps.google.com/?q=Restaurante+Manjericão+Ilhabela' },
      { id: 'ilh-r3', name: 'Restaurante Pescadora', category: 'frutos_do_mar', priceRange: 3, averageTicket: 95, rating: 4.7, address: 'Av. Força Expedicionária Brasileira, 495 - Santa Tereza, Ilhabela', lat: -23.7780, lng: -45.3524, highlights: ['Chef Renata Vanzetto — ex-MasterChef', 'Na antiga garagem de barcos da família', 'Cardápio de influência caiçara'], mapsUrl: 'https://maps.google.com/?q=Restaurante+Pescadora+Ilhabela' },
      { id: 'ilh-r4', name: 'Ben\'s Bar', category: 'bar', priceRange: 2, averageTicket: 45, rating: 4.4, address: 'Av. José Pacheco do Nascimento, 9836 - Cabaraú, Ilhabela', lat: -23.8300, lng: -45.3700, highlights: ['Pôr do sol inesquecível', 'Visita de macaquinhos', 'Drinks tropicais e petiscos'], mapsUrl: 'https://maps.google.com/?q=Ben\'s+Bar+Ilhabela' },
      { id: 'ilh-r5', name: 'Deck Bar Perequê', category: 'bar', priceRange: 2, averageTicket: 38, rating: 4.3, address: 'Av. Pedro Paulo de Moraes, 890 - Perequê, Ilhabela', lat: -23.7780, lng: -45.3528, highlights: ['Deck sobre o canal', 'Caipirinhas artesanais', 'Música ao vivo nas sextas'], mapsUrl: 'https://maps.google.com/?q=Deck+Bar+Perequê+Ilhabela' },
      { id: 'ilh-r6', name: 'Café da Balsa', category: 'cafe', priceRange: 1, averageTicket: 20, rating: 3.9, address: 'Terminal da Balsa - Perequê, Ilhabela', lat: -23.7779, lng: -45.3526, highlights: ['Café e tapioca enquanto espera a balsa', 'Rápido e prático', 'Pão de queijo artesanal'], mapsUrl: 'https://maps.google.com/?q=Café+da+Balsa+Ilhabela' },
    ],
    attractions: [
      { id: 'ilh-a1', name: 'Praia dos Castelhanos', type: 'praia', description: 'A mais famosa de Ilhabela, de difícil acesso (4x4) e das mais belas do Brasil, com ondas para surf.', entryFee: null, rating: 4.9, lat: -23.8580, lng: -45.2850, tips: ['Acesso só de 4x4 — contratar excursão em Ilhabela', 'Leve comida própria — sem comércio', 'Melhor temporada de surf: abr–ago'], mapsUrl: 'https://maps.google.com/?q=Praia+dos+Castelhanos+Ilhabela' },
      { id: 'ilh-a2', name: 'Pico do Baepi', type: 'trilha', description: 'Trilha até os 640m de altitude, com vista de 360° do arquipélago de Ilhabela e do continente.', entryFee: null, rating: 4.8, lat: -23.7800, lng: -45.3200, tips: ['Saída às 6h para evitar chuva da tarde', 'Guia obrigatório em temporada', 'Nível difícil — prepare-se fisicamente'], mapsUrl: 'https://maps.google.com/?q=Pico+do+Baepi+Ilhabela' },
      { id: 'ilh-a3', name: 'Cachoeira da Laje', type: 'cachoeira', description: 'Queda d\'água de 30m com piscina natural de cor esmeralda, acessível por trilha de 1h pela Mata Atlântica.', entryFee: null, rating: 4.7, lat: -23.8100, lng: -45.3400, tips: ['Leve roupas para molhar', 'Trilha moderada — tênis fechado obrigatório', 'Evitar nos dias após chuva forte'], mapsUrl: 'https://maps.google.com/?q=Cachoeira+da+Laje+Ilhabela' },
      { id: 'ilh-a4', name: 'Museu Histórico e Arqueológico de Ilhabela', type: 'historico', description: 'Sede colonial do século XVIII com acervo sobre piratas, naufrácios históricos e a cultura caiçara.', entryFee: 8, rating: 4.2, lat: -23.7760, lng: -45.3514, tips: ['Fechado às terças', 'Visita guiada inclusa no ingresso', 'Loja de artesanato caiçara na saída'], mapsUrl: 'https://maps.google.com/?q=Museu+Histórico+Ilhabela' },
    ],
    sideRoutes: [
      { id: 'ilh-sr1', name: 'Praia dos Castelhanos', description: 'A mais bela de Ilhabela — acesso via 4x4 ou barco, ondas incríveis e quase nenhum turismo de massa.', type: 'praia', distance: 30, estimatedTime: 60, difficulty: 'difícil', tags: ['praia', 'surf', 'selvagem'], lat: -23.8580, lng: -45.2850, mapsUrl: 'https://maps.google.com/?q=Praia+dos+Castelhanos,+Ilhabela,+SP&ll=-23.8580,-45.2850' },
      { id: 'ilh-sr2', name: 'Cachoeira da Laje', description: 'Queda de 30m com piscina natural esmeralda — trilha de 1h pela mata atlântica preservada.', type: 'cachoeira', distance: 12, estimatedTime: 25, difficulty: 'moderado', tags: ['cachoeira', 'trilha', 'natureza'], lat: -23.8100, lng: -45.3400, mapsUrl: 'https://maps.google.com/?q=Cachoeira+da+Laje,+Ilhabela,+SP&ll=-23.8100,-45.3400' },
      { id: 'ilh-sr3', name: 'Pico do Baepi', description: 'Trilha até 640m com vista de 360° do arquipélago — saída às 6h para evitar chuva da tarde.', type: 'trilha', distance: 8, estimatedTime: 30, difficulty: 'difícil', tags: ['trilha', 'altitude', 'vista 360°'], lat: -23.7800, lng: -45.3200, mapsUrl: 'https://maps.google.com/?q=Pico+do+Baepi,+Ilhabela,+SP&ll=-23.7800,-45.3200' },
      { id: 'ilh-sr4', name: 'Praia do Jabaquara', description: 'Praia de baía com águas calmas e rasas, ideal para famílias com crianças — bem menos movimentada.', type: 'praia', distance: 4, estimatedTime: 8, tags: ['praia', 'família', 'calmo'], lat: -23.7600, lng: -45.3500, mapsUrl: 'https://maps.google.com/?q=Praia+do+Jabaquara,+Ilhabela,+SP&ll=-23.7600,-45.3500' },
    ],
  },
];
